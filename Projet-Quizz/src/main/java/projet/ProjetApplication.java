...
public class ProjetApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		User user1 = new User("flauzac","olivier","olivier@gmail.com","olivier","olivier","enseignant",true);
		...
		User eleve1 = new User("bahammou","mohamed","mohamed@gmail.com","mohamed123","mohamed123","eleve",true);
